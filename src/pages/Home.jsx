  ...
  <div className="px-8 md:px-20 lg:px-40 space-y-12">
    ...
    <div className="flex flex-col md:flex-row md:items-center md:space-x-8">
      ...
      <div className="md:w-3/4 w-full">
        ...
        <p className="text-gray-600">
        Amass Computer Solution quickly identifies common issues like cracked screens, 
    ...
    <div className="flex flex-col md:flex-row md:items-center md:space-x-8">
      ...
      <div className="md:w-3/4 w-full">
        ...
        <p className="text-gray-600">
          Amass Computer Solution's tech whizzes use gadgets like multi-meters to fix parts 
...
>
    ...
    <SwiperSlide>
      <img src={assus} alt="Razer" className="mx-auto h-24" />
    </SwiperSlide>
    <SwiperSlide>
      <img src={hp} alt="Lava" className="mx-auto h-24" />
    </SwiperSlide>
    <SwiperSlide>
      <img src={acer} alt="MSI" className="mx-auto h-24" />
    </SwiperSlide>
    <SwiperSlide>
        ...
        >
          ...
          <SwiperSlide>
            <div className="bg-white p-8 rounded-2xl shadow-lg">
              ...
              <p className="text-lg text-gray-700 mb-4 font-semibold">
              "Amass Computerw is my go-to shop for all things tech! The staff is incredibly knowledgeable and always 
