...
>
        ...
        <div className="lg:col-span-2 lg:col-start-1 lg:row-start-2 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
          <div className="lg:pr-4">
            <div className="max-w-xl text-base/7 text-gray-700 lg:max-w-lg">
              ...
              <h2 className="mt-16 text-2xl font-bold tracking-tight text-gray-900">Located in Kathmandu, Baneshwor.</h2>
              <p className="mt-6">
              We are conveniently located at Bhakti Thapa Sadak in Baneshwor, Kathmandu. Stop by and let us take care of your 
  ...
  <p className="mb-2">
    <a href="tel:+9779843927276" className="text-blue-600 hover:underline">
      📞 (977) 9843927276
    </a>
  </p>
  <p>
    <a
      href="mailto:pcshopnepal@gmail.com"
      className="text-blue-600 hover:underline"
    >
      ✉️ pcshopnepal@gmail.com
    </a>
  </p>
</div>
